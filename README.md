...
5. 스터디 멤버간 실시간 채팅기능
   - WebSocket (STOMP + SockJS) 기반 실시간 채팅
   - 채팅 메시지 Infinite Scroll Pagination
   - 동일 사용자 연속 메시지 UI Grouping 처리
   - 채팅 하단이 아닐 경우 New Message Indicator 표시
   - 메시지 날짜별 구분선 자동 생성
